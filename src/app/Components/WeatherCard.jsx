...
function WeatherCard(props) {
  ...
  const temp=temp_c?Math.round(temp_c ):"--";
  const feels_like=feels_like_c?Math.round(feels_like_c ):"--";
...
<div className="sm:w-[35rem] w-[21rem] h-96 sm:h-[25rem]  bg-white py-4 px-5 rounded-xl ring-8 ring-white ring-opacity-40 overflow-hidden">
<h1 className="text-slate-600 font-extrabold pb-4 text-3xl ">
  Today's Weather
</h1>
    <div className="flex justify-between sm:px-8">
        <div className="flex flex-col">
            <span className="text-6xl font-bold text-gray-500">{temp}°C</span>
    ...
    <div className="flex justify-between mt-8 overflow-x-scroll overflow-y-hidden scroll gap-10 sm:mx-8 mx-1">    
        {
